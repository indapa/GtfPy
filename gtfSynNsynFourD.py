    ...
    for cdsgtf in getCds(gtf_fh):
        ...
        if cdsgtf.getStrand() == '+':
            for codon, aa, codonStart, codonEnd in cdsgtf.walkCdsFwd( twobit ):
                #print codon, aa, cdsgtf.getSeqName(), codonStart, codonEnd, codonTable.codon_degeneracy(codon,1), codonTable.codon_degeneracy(codon,2),codonTable.codon_degeneracy(codon,3), cdsgtf.getStrand()
